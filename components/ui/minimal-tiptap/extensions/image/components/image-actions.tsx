...
export const ImageActions: React.FC<ImageActionsProps> = ({ shouldMerge = false, isLink = false, ...actions }) => {
      ...
      {shouldMerge ? (
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
          <DropdownMenuTrigger asChild>
            <ActionButton icon={<DotsHorizontalIcon />} tooltip="Open menu" onClick={(e) => e.preventDefault()} />
          </DropdownMenuTrigger>
